...
//            // Some work for showing image
//            Drawable[] layers = new Drawable[2];
//            layers[1] = new BitmapDrawable(mPosting.getPhoto());
//            if (mPosting.getStatus() != null &&
//                    mPosting.getStatus().equals("Rented")) {
//                layers[0] = getResources().getDrawable(R.drawable.rented_img);
//                layers[1].setAlpha(64);
//            } else if (mPosting.getStatus() != null &&
//                    mPosting.getStatus().equals("Cancelled")) {
//                layers[0] = getResources().getDrawable(R.drawable.cancelled_img);
//                layers[1].setAlpha(64);
//            } else {
...
//            mPhoto.setImageBitmap(mPosting.getPhoto());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPostingRecyclerView = (RecyclerView) view
                .findViewById(R.id.edit_posting_recycle_view);
...
//        List<Posting> postings = postingList.getPostings();
    ...
    private void setNavigationDrawer(View view) {
        ...
        mDrawerLayout = (DrawerLayout) view.findViewById(R.id.drawer_layout_edit_post);
        mDrawerToggle  =
