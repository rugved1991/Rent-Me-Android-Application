...
//            Intent intent = UpdatePostDetailActivity.newIntent(getActivity(), mPosting.getPostId());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPostingRecyclerView = (RecyclerView) view
                .findViewById(R.id.search_results_recycle_view);
...
//        List<Posting> postings = postingList.getPostings();
    ...
    private void setNavigationDrawer(View view) {
        ...
        mNavigationView = (NavigationView) view.findViewById(R.id.navigation_view_search_results);
        ...
        mDrawerLayout = (DrawerLayout) view.findViewById(R.id.drawer_layout_search_results);
        mDrawerToggle  =
